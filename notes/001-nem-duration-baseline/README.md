...
- **CI Verification:** [Re-executed in CI environment (run #29683583017)](https://github.com/VolMax-Studio/Open-Market-Notes/actions/runs/29683583017)
...
### Fleet Monthly Average Cycling
| Month | EFC/month | EFC/day |
|:---|:---:|:---:|
| **2025-06** | 31.67 | 1.06 |
| **2025-07** | 32.82 | 1.06 |
| **2025-08** | 32.84 | 1.06 |
...
## 5. Pre-Publication Note Revision History (Draft Revisions leading to v1.0.0 Release)
