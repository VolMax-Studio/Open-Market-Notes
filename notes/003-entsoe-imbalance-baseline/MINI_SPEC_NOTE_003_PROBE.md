...
> **Probe Evaluator Script (`evaluate_probe.py`) SHA-256:** `20081488df6fe358312cb7ef47a6378394322429f4eb5bee939c416d5889ade0`  
...
- **Probe Telemetry Persistence:** Probe processed telemetry files (`probe_jul2026/processed/*.feather`, ~324 KB total) are committed directly to the repository to guarantee standalone out-of-the-box evaluation reproducibility without requiring ENTSO-E API key credentials.
