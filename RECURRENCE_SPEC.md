# VolMax Open Market Notes — Recurrence Specification v1.0.1

> **Class of Work:** VolMax Governance Specification & Automation Standard  
> **Status:** Draft for Ratification (v1.0.1 Gate Remediation)  
> **Version:** 1.0.1  
...
- The Pull Request MUST contain:
  ...
  3. Appended measurement record entry in `history/measurement_log.json`.
  4. A mechanical PR diff summary highlighting metric changes relative to the previous ratified baseline.
...
### Mandate 5: Measurement History Persistence Architecture
...
Each ratified run appends an immutable JSON record:
```json
{
  "version": "v1.1.0",
  "measurement_window": "2025-07-01 to 2026-07-31",
  "results_sha256": "c192e7ee97ac413a07db6a1357f0dbcf49c1164cdbe0a5a4c0f5e9b113b614ed",
  "input_manifest_sha256": "8a31b40280f9...a02931",
  "ratified_at": "2026-08-15T12:00:00Z"
}
```

### Mandate 6: Execution Modes (Automated vs. Manual Recurrence)
...
### Mandate 7: Telemetry Failure & Data Boundary Rule
...
### Mandate 8: Zero Secret Leakage Policy
...
[ Runner Environment (Automated or Manual Recurrence) ]
                 ...
                 └── 6. Append entry to history/measurement_log.json
                 │
                 ▼
...
- `[ ]` `history/measurement_log.json` correctly appended with the new measurement record.
- `[ ]` Zero modified lines in `PARAMS.md` or core calculation logic.

---

*VolMax Studio Lab · Recurrence Specification v1.0.1 (Governance & Automation Standard)*
