...
```json
{
  ...
  "q_ref": 0.90,
  "k_multiplier": 1.50,
  "s_thresh_formula": "k_multiplier * (1.0 - q_ref) = 0.150 (discrete rounded threshold = 20.0% for 10 MTUs)",
  "s_thresh_pct": 20.0,
  ...
  "series_bindings": {
    ...
    "PT": {"imbalance_col": "imbalance_price_eur_mwh", "interval_sec": 900.0, "nominal_mtus": 10},
    "FR": {"imbalance_col": "imbalance_price_eur_mwh", "interval_sec": 900.0, "nominal_mtus": 10},
    "DE_LU": {"imbalance_col": "imbalance_price_eur_mwh", "interval_sec": 900.0, "nominal_mtus": 10},
    "NL": {"imbalance_col": "imbalance_price_eur_mwh", "interval_sec": 900.0, "nominal_mtus": 10}
  },
